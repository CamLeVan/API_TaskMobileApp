...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/invitations', [TeamInvitationController::class, 'getUserInvitations']);
    Route::post('/teams/{teamUuid}/invite', [TeamInvitationController::class, 'inviteByUuid']);
    ...
    Route::post('/settings/reset', [UserSettingController::class, 'reset']);
